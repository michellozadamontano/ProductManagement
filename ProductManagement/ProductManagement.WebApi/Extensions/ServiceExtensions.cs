...
namespace ProductManagement.WebApi.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Clean Architecture - ProductManagementAPI",
                    Description = "This Api will be responsible for overall data distribution and authorization.",
                    Contact = new OpenApiContact
                    {
                        Name = "Michel Lozada Montano",
                        Email = "michellm8426@gmail.com",
                        Url = new Uri("https://linkedin.com/in/michel-lozada-montano-65708966"),
                    }
                });
        ...
        public static void AddAuthorizationPolicies(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy(AuthorizationConsts.UserPolicy, policy => policy.RequireRole(user, admin));

                options.AddPolicy("ApiScope", policy =>
                {
                    policy.RequireAuthenticatedUser();
                    policy.RequireClaim("scope", "api_pm");
                });
